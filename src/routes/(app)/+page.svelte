...
<div>
  ...
  <section class="container mx-auto space-y-2 max-w-2xl">
    <h3 class="text-4xl font-bold text-white mask font-ibm italic mb-4 text-center">
    ...
    <div class="collapse rounded-none collapse-arrow">
      ...
      on:click={() => {
        ...
        class="collapse-title bg-transparent text-white peer-checked:bg-primary peer-checked:text-black text-left mask font-ibm italic">
        {question}
      </button>
      <div
